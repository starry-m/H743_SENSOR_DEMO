...
void MX_IKS4A1_DataLogTerminal_Init(void)
{
  ...
  int i;
  MX_UART_InitTypeDef m_com={.BaudRate=115200,.WordLength=UART_WORDLENGTH_8B,.StopBits=UART_STOPBITS_1,.Parity=UART_PARITY_NONE,.HwFlowCtl=UART_HWCONTROL_NONE};
  /* Initialize LED */
  BSP_LED_Init(LED2);
